...
import { Severity, IndicatorType, SeverityOption, IndicatorTypeOption } from '@/types/indicator';
...
const TYPES: IndicatorTypeOption[] = [
    ...
    <div className="px-8 py-4 flex items-center gap-3 bg-bg-surface border-b border-border-subtle flex-wrap">
      ...
      <div className="ml-auto">
        <button
          ...
          className="text-text-secondary hover:text-text-primary transition-colors text-[11.5px] font-semibold px-2 py-1 h-8 bg-transparent border-none cursor-pointer"
        >
          Clear filters
        </button>
      </div>
